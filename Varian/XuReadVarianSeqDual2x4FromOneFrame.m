function [data_low_gain, data_high_gain]=XuReadVarianSeqDual2x4FromOneFrame(fid,begin_idx,number_of_frames,height_begin,height_end)
%[data_low_gain, data_high_gain]=ReadVarianSeqDual2x4FromOneFrame(fid,begin_idx,number_of_frames,height_begin,height_end)
...
for frameidx=1:number_of_frames
    ...
    fseek(fid,2048+(2048*384*2)*(frameidx-1+begin_idx-1),'bof');
