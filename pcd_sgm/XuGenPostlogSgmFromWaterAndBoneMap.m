function sgm_chromatic_postlog = XuGenPostlogSgmFromWaterAndBoneMap(sgm_water,sgm_bone,energy_simu,spec_simu)
...
sgm_chromatic_postlog = -log(sgm_chromatic_prelog);
