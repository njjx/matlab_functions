function prj_corr = MgPanelCorrectionFirstOrder(prj_postlog, material, energyBin, slice_count, truncation_left, truncation_right, protocol)
...
for slice_idx = 1:slice_count
    ...
    for col = truncation_left:truncation_right
        ...
        temp_coef = temp_coef/pixel_per_one_slice*0.0207;
        temp_coef = temp_coef(end-1:end);
